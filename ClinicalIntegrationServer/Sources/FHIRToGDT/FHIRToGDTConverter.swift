    ...
    private func isECGObservation(_ observation: Observation) -> Bool {
        ...
        for coding in codings {
            ...
            if let displayValue = coding.display?.value?.string {
                ...
                if display.contains("ecg") || display.contains("ekg") || display.contains("electrocardiogram")
                    || display.contains("elektrokardiogramm")
                {
                    return true
                }
            }
        ...
        if let textValue = observation.code.text?.value?.string {
            ...
            if text.contains("ecg") || text.contains("ekg") || text.contains("electrocardiogram") || text.contains("elektrokardiogramm") {
                return true
            }
        }
